...
import { Box, Flex, Grid, GridItem, Card } from "@chakra-ui/react";
  ...
  return (
    <Box>
      <Flex width="full" gap={4} mb={4} direction={{ base: "column", md: "row" }}>
        ...
        >
          <SparkLineChart data={pendingData.data} color="yellow.solid" />
        </SparklineCard>
        ...
        >
          <SparkLineChart data={inProgressData.data} color="blue.solid" />
        </SparklineCard>
        ...
        >
          <SparkLineChart data={completedData.data} color="green.solid" />
        </SparklineCard>
        ...
        >
          <SparkLineChart data={overdueData.data} color="red.solid" />
        </SparklineCard>
      </Flex>
